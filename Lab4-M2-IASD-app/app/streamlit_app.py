...
def plot_curves(results: dict, model_name: str) -> plt.Figure:
    ...
    axes[0].plot(epochs_range, results["train_losses"], label="Train Loss", marker="o")
    axes[0].plot(epochs_range, results["val_losses"], label="Val Loss", marker="o")
    ...
    axes[1].plot(epochs_range, results["train_accs"], label="Train Acc", marker="o")
    axes[1].plot(epochs_range, results["val_accs"], label="Val Acc", marker="o")
    ...
    axes[2].plot(epochs_range, results["train_aucs"], label="Train AUC", marker="o")
    axes[2].plot(epochs_range, results["val_aucs"], label="Val AUC", marker="o")
